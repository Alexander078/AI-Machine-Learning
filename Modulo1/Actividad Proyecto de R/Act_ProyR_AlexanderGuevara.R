#Actividad: Proyecto de R by Alexander Guevara
...
# Al ser un dataset de manufactura de vehiculos considere no eliminar ningun duplicado
# tomando en cuenta que se pueden manufacturar vehiculos de las mismas caracteristicas
